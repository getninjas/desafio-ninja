...
RSpec.describe "/schedulings", type: :request do
  ...
  # Scheduling. As you add validations to Scheduling, be sure to
  ...
  # SchedulingsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Scheduling.create! valid_attributes
      get schedulings_url, headers: valid_headers, as: :json
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get scheduling_url(scheduling), as: :json
      expect(response).to be_successful
    end
  end

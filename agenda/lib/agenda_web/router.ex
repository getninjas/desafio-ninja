defmodule AgendaWeb.Router do
  ...
  scope "/api", AgendaWeb do
    pipe_through [:api]
    get "/scheduler", SchedulerController, :show
    post "/scheduler", SchedulerController, :create
    put "/scheduler/edit/:schedule_title", SchedulerController, :update
    delete "/scheduler/:schedule_title", SchedulerController, :delete
  end
